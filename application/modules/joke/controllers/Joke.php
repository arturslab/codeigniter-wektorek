...
class Joke extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->defaultPageUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/joke/';
        ...
        $this->view_data['module_css']  = 'joke.css';
        $this->view_data['module_js']   = 'avatar.js';
        $this->view_data['module_name'] = 'joke';
        $this->view_data['module_path'] = '/application/modules/joke';
        $this->view_data['module_url']  = 'http://' . $_SERVER['HTTP_HOST'] . '/joke/';
    }
