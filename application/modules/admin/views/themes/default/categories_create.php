...
<div class="section-page-heading d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0">Nowa kategoria</h1>
</div>
...
<div class="row">
    ...
    <div class="col-md-6 mb-4">
        <?php
        echo form_open('/admin/categories/create', ['id' => 'edit-form']);
        ?>

        <div class="form-group">
            <?php
            echo form_label('Kategoria nadrzędna', 'parent_id');
            echo form_dropdown('parent_id', $category_options, set_value('parent_id'), ['id'=>'parent_id', 'class' => 'form-control', 'aria-describedby' => 'parent_help_block']);
        ...
        <div class="form-group">
            ...
            echo form_input(['name' => 'name', 'class' => 'form-control'], set_value('name'));
            ?>
        </div>
