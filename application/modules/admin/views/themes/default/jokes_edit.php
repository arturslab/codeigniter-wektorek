...
<div class="section-page-heading d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0">Edycja dowcipu</h1>
</div>
...
<div class="row">
	...
	<div class="col-md-11 mb-4">
        <?php
        echo form_open('/admin/jokes/edit/' . $post->id, ['id' => 'edit-form']);
        ?>

		<div class="form-group">
            <?php
            echo form_label('Kategoria', 'parent_id');
            echo form_dropdown('category_id', $category_options, set_value('category_id', $post->category_id), ['id'=>'category_id', 'class' => 'form-control', 'aria-describedby' => 'category_help_block']);
		...
		<div class="form-group">
            ...
            echo form_input(['name' => 'title', 'class' => 'form-control'], set_value('title', $post->title));
            echo form_error('title', '<span class="form_error">', '</span>');
            ?>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php
				echo form_input(['name' => 'slug', 'class' => 'form-control', 'aria-describedby' => 'slug_help_block'], set_value('slug', $post->slug));
				?>
			</div>
				<?php
		...
		<div class="form-group">
            ...
            echo form_textarea(['name' => 'content', 'class' => 'form-control', 'rows'=>7], set_value('content', $post->content));
            ?>
		</div>
